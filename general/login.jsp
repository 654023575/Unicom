        ...
        <div class="content">
            ...
            <form class="login-form" action="${ctx}/login" method="post">
                ...
                <div class="alert alert-error" style="display: none">
                    <span class="iconsm iconsm-warning text-center"></span><span id="errorMsg" style="color: red"></span>
                </div>
                <div class="form-group">
                    <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                    <label class="control-label visible-ie8 visible-ie9">用户名</label>
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="用户名" name="username" value="${username}"/> </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">密码</label>
                    <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="密码" name="password" value="${password}"/> 
                    </div>
                <div class="form-group">
