app.controller('DictionaryController', ['$state','$scope', 'Restangular' ,'ngTableParams', 'dialogs', 'toaster', 'LeasingCommon',
    ...
    var create1=function(){
    	$state.go("app.s2.dictionary-create",null,null);
    }
    var create = function () {
    	$state.go("app.s2.dictionary-mgmt",null,null);
    }
    
    var edit = function (id) {
    	$state.go("app.s2.dictionary-mgmt",{"id": id},null);
    }
	$scope.show=false;
    var view = function (id) {
    	$scope.show=true;
    	$state.go("app.s2.dictionary-view",{"id": id},null);
    };
